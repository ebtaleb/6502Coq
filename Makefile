...
# coq_makefile -o Makefile AbstractMachine.v AbstractMemory.v AbstractRegister.v Coqlib.v Insert.v Instructions.v MachineInt.v Main.v NI_Main_R.v NI_MemoryR.v Repeat.v 
#
